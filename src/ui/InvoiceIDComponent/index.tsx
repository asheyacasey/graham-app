...
const InvoiceIDComponent = ({ text, className }: InvoiceIDComponentProps) => {
    ...
    return (
        <div onClick={handleCopyText} className={cn('cursor-pointer', className)}>{truncateString(text)}</div>
    )
}
