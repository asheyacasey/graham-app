...
const SellerAccount = () => {
    ...
    const GetOrders = useCallback(() => {
        dispatch(get_seller_orders_thunk({ page: 1, title: "", is_buyer: true }))
    }, [dispatch])
    useEffect(() => {
        GetOrders()
    }, [GetOrders])
                    ...
                    <div className="mt-6 md:flex md:items-center md:justify-between md:space-y-0 space-y-3">
                        <div className='w-64'>
                            <Input
                                ...
                                onChange={(e) => {
                                    dispatch(get_seller_orders_thunk({ page: 1, title: e.target.value, is_buyer: true }))
                                }}
                            ...
                            <>
                                ...
                                <Pagination
                                    ...
                                    onPageChange={(page: number) => {
                                        dispatch(get_seller_orders_thunk({ page: page, title: sellerState.orders.title, is_buyer: true }))
                                    }}
                                />
                            </>
                            :
